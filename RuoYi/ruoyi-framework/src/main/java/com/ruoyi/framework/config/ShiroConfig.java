...
public class ShiroConfig
{
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager)
    {
        ...
        /*vue*/
//        filterChainDefinitionMap.put("/api/mj/**", "anon");
//        filterChainDefinitionMap.put("/mj.html", "anon");
//        filterChainDefinitionMap.put("/assets/**", "anon");
//        filterChainDefinitionMap.put("/vite.svg", "anon");
//        filterChainDefinitionMap.put("/api/chat/**", "anon");
        ...
        filterChainDefinitionMap.put("/agreement/**", "anon");//用户协议
        filterChainDefinitionMap.put("/kefu/**", "anon");//客服
        filterChainDefinitionMap.put("/kf/**", "anon");//客服
        filterChainDefinitionMap.put("/profile/**", "anon");//图片
        filterChainDefinitionMap.put("/openai/**", "anon");//图片
        filterChainDefinitionMap.put("/pay/**", "anon");//支付回调
